...
namespace SerialCommunicationUWP
{
    ...
    /// </summary>
    public class EventHandlerForDevice : INotifyPropertyChanged
    {
        /// <summary>
        ...
        private async void CloseCurrentlyConnectedDevice()
        {
            if (device != null)
            {
                ...
                () =>
                {
                    //TODO SerialMain.NotifyUser(deviceId + " is closed", NotifyType.StatusMessage);
                });
            }
        }
        ...
        private void RegisterForAppEvents()
        {
            ...
            // TODO App.Current.Suspending += appSuspendEventHandler;

            // TODO App.Current.Resuming += appResumeEventHandler;
        }
